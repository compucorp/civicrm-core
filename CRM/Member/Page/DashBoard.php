...
class CRM_Member_Page_DashBoard extends CRM_Core_Page {
  ...
  public function preProcess() {
    ...
    // Gather every dashboard count for all membership types in two grouped queries rather than the
    // ~16 per-type queries this loop previously issued (see getMembershipSummaryStats()).
