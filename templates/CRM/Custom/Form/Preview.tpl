...
{foreach from=$groupTree item=cd_edit key=group_id}
  ...
  {if !empty($element.options_per_line)}
        ...
        <tr>
         <td class="label">{$form.$element_name.label}{if !empty($element.help_post)}{help id=$element.id file="CRM/Custom/Form/CustomField.hlp" title=$form.$element_name.label|escape}{/if}</td>
         <td>
